...
OCX mirror for [hyperfine](https://github.com/sharkdp/hyperfine). Publishes
GitHub releases to `ocx.sh/hyperfine` with cascade tags after a smoke
...
Apache-2.0 — see [`LICENSE`](LICENSE). Upstream assets (hyperfine name,
